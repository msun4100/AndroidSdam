...
public class TabsAdapter extends FragmentPagerAdapter implements
	...
	public final static int MESSAGE_PAGE_AFTER_WRITE = 2;
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_PAGE_AFTER_WRITE:
				int position2 = msg.arg1;
				Fragment f2 = getTabFragment(position2);
				if (f2 != null && f2 instanceof PagerFragment) {
					((PagerFragment)f2).onPageCurrent();
				}//if
			}//switch
		}
	};
