...
public class TabThreeItemView extends FrameLayout {
	...
	public TabThreeItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	...
	public OnClickListener viewListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.image_report:
				if (mListener != null) {
					mListener.onLikeClick(TabThreeItemView.this, mItem,
	...
	public void setItemData(TabThreeResult item) {
		mItem = item;
